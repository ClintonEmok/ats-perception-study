...
const WORKFLOW_STEPS = [
  { id: 'overview', label: 'OVERVIEW', active: true, accent: THEME.navy },
  { id: 'select', label: 'SELECT', active: true, accent: THEME.tueRed },
  { id: 'inspect', label: 'INSPECT', active: false, accent: THEME.textMuted },
            ...
            <div
              style={{
                ...
                background: step.active
                  ...
                  : 'transparent',
                border: step.active
                  ? `1px solid ${step.id === 'select' ? THEME.tueRedBorder : 'rgba(15, 23, 42, 0.14)'}`
